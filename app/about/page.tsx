    ...
    <div>
      ...
      <section className="container py-8 md:py-12">
        ...
        <p className="text-cocoa/80 max-w-3xl leading-relaxed mx-auto">
          At {settings?.businessName ?? 'TheHive Cakes'}, we&apos;ve spent the past {settings?.yearsExperience ?? 4} years
        ...
        <div className="mt-8 p-6 rounded-2xl bg-cream mx-auto max-w-3xl">
          <p className="font-medium text-cocoa text-center">“{settings?.tagline ?? 'Satisfying your cravings with every bite and sip.'}”</p>
        </div>
      </section>
      <Footer />
    </div>
